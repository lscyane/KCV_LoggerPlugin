...
namespace KCVLoggerPlugin.Models
{
    ...
    /// </remarks>
    public class AachievementLog : LogBase<AachievementLogStruct>
    {
        /*
        ...
        /// </value>
        public new static AachievementLog Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (lockForSingleton)
                    {
                        if (instance == null)
                        {
                            ...
                            instance = new AachievementLog();
                        }
                    }
                }
                // instance フィールドに格納されている型は基底クラスのため、
                // 派生クラスにキャストして返す。
                return (AachievementLog)instance;
            }
        }
        ...
        {
            ObservableCollection<AachievementLogStruct> data = new ObservableCollection<AachievementLogStruct>();
			...
			while (parser.Read())
			{
                ...
                // データ格納
                data.Add(new AachievementLogStruct(
        ...
        public override void ExportCsv(String path)
        {
            ...
            foreach (AachievementLogStruct bl in this.History)
            {
